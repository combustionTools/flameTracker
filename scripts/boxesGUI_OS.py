...
def manualTrackingBox(self):
    ...
    self.MTmenu = self.menu.addMenu('&Tracking options')
    self.MTmenu.addAction(self.showLines_MT)
    self.MTmenu.addAction(self.absValBtn_MT)
...
def lumaTrackingBox(self):
    ...
    self.LTmenu = self.menu.addMenu('&Tracking options')
    self.LTmenu.addAction(showFrameLargeBtn_LT)
    self.LTmenu.addAction(self.filterLight_LT)
    self.LTmenu.addAction(self.lightROIBtn_LT)
    self.LTmenu.addAction(self.absValBtn_LT)
...
def colorTrackingBox(self):
    ...
    self.box_layout.addWidget(self.colorTrackingBtn, 5, 5, 1, 2)
    ...
    self.RTmenu = self.menu.addMenu('&Tracking options')
...
def HSVTrackingBox(self):
    ...
    # self.box_layout.addWidget(txt_lbl1, 10, 10, 1, 1)
    # self.box_layout.addWidget(xAxisTxt_lbl1, 10, 10, 1, 1)
    # self.box_layout.addWidget(self.xAxis_lbl1, 10, 11, 1, 1)
    # self.box_layout.addWidget(yAxisTxt_lbl1, 11, 10, 1, 1)
    # self.box_layout.addWidget(self.yAxis_lbl1, 11, 11, 1, 1)
    # self.box_layout.addWidget(txt_lbl2, 10, 13, 1, 1)
    # self.box_layout.addWidget(xAxisTxt_lbl2, 10, 13, 1, 1)
    # self.box_layout.addWidget(self.xAxis_lbl2, 10, 14, 1, 1)
    # self.box_layout.addWidget(yAxisTxt_lbl2, 11, 13, 1, 1)
    # self.box_layout.addWidget(self.yAxis_lbl2, 11, 14, 1, 1)
...
#    self.box_layout.setColumnMinimumWidth(12, 50)
    ...
    self.HTmenu = self.menu.addMenu('&Tracking options')
