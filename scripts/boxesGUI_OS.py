...
def previewBox(self):
    ...
    # first column
    self.msgLabel = ft.QLabel('Welcome to Flame Tracker!')
    ...
    self.measureScaleTxt = ft.QLabel('Scale px/len:')
    ...
    self.frameTxt = ft.QLabel('Frame:')
    # self.frameTxt.setFixedWidth(80)
    self.frameIn = ft.QLineEdit('0')
    self.frameIn.setMinimumWidth(50)
    # self.frameIn.setFixedWidth(80)
    self.timeTxt = ft.QLabel('Time:')
    self.timeIn = ft.QLineEdit('0')
    self.timeIn.setMinimumWidth(50)
    # self.timeIn.setFixedWidth(80)
    self.goToFrameBtn = ft.QPushButton('Go to frame')
    self.goToFrameBtn.clicked.connect(self.goToFrameBtn_clicked)
    self.goToTimeBtn = ft.QPushButton('Go to time')
    self.goToTimeBtn.clicked.connect(self.goToTimeBtn_clicked)
    ...
    self.fastBwdFrameBtn = ft.QPushButton('<<')
    self.fastBwdFrameBtn.clicked.connect(self.fastBwdFrameBtn_clicked)
    # self.fastBwdFrame.setFixedWidth(40)  # width in pixels
    self.bwdFrameBtn = ft.QPushButton('<')
    self.bwdFrameBtn.clicked.connect(self.bwdFrameBtn_clicked)
    # self.bwdFrame.setFixedWidth(40)  # width in pixels
    self.fwdFrameBtn = ft.QPushButton('>')
    self.fwdFrameBtn.clicked.connect(self.fwdFrameBtn_clicked)
    # self.fwdFrame.setFixedWidth(40)  # width in pixels
    self.fastFwdFrameBtn = ft.QPushButton('>>')
    self.fastFwdFrameBtn.clicked.connect(self.fastFwdFrameBtn_clicked)
    # self.fastFwdFrame.setFixedWidth(40)  # width in pixels

    # parametersBox_layout.addWidget(self.win1, 0, 9, 9, 4)
    parametersBox_layout.addWidget(self.win1, 0, 9, 9, 8)
    # parametersBox_layout.addWidget(self.frameTxt, 9, 10, 1, 1)
    # parametersBox_layout.addWidget(self.frameIn, 9, 11, 1, 1)
    parametersBox_layout.addWidget(self.frameTxt, 9, 11, 1, 1)
    parametersBox_layout.addWidget(self.frameIn, 9, 12, 1, 1)
    parametersBox_layout.addWidget(self.timeTxt, 9, 13, 1, 1)
    parametersBox_layout.addWidget(self.timeIn, 9, 14, 1, 1)
    # parametersBox_layout.addWidget(self.goToFrameBtn, 9, 12, 1, 1)
    parametersBox_layout.addWidget(self.goToFrameBtn, 9, 9, 1, 2)
    parametersBox_layout.addWidget(self.goToTimeBtn, 9, 15, 1, 2)
    # parametersBox_layout.addWidget(self.previewSlider, 10, 9, 1, 4)
    parametersBox_layout.addWidget(self.previewSlider, 10, 11, 1, 4)
    parametersBox_layout.addWidget(self.fastBwdFrameBtn, 10, 9, 1, 1)
    parametersBox_layout.addWidget(self.bwdFrameBtn, 10, 10, 1, 1)
    parametersBox_layout.addWidget(self.fwdFrameBtn, 10, 15, 1, 1)
    parametersBox_layout.addWidget(self.fastFwdFrameBtn, 10, 16, 1, 1)
    ...
    # parametersBox_layout.setColumnMinimumWidth(9, 50)
    # parametersBox_layout.setColumnMinimumWidth(10, 50)
    # parametersBox_layout.setColumnMinimumWidth(11, 100)
    # parametersBox_layout.setColumnMinimumWidth(12, 100)
    # parametersBox_layout.setColumnMinimumWidth(13, 100)
    # parametersBox_layout.setColumnMinimumWidth(14, 100)
    ...
    # parametersBox_layout.setColumnStretch(10, 1)
    # parametersBox_layout.setColumnStretch(11, 1)
    # parametersBox_layout.setColumnStretch(12, 1)
    # parametersBox_layout.setColumnStretch(13, 1)
    # parametersBox_layout.setColumnStretch(14, 1)
...
def manualTrackingBox(self):
    ...
    self.yAxis_lbl2.addItem('y coord.')
