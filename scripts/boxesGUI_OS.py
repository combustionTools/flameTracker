...
def manualTrackingBox(self):
    ...
    self.box_layout.setColumnMinimumWidth(3, 40)
...
def colorTrackingBox(self):
    ...
    self.redMinLeftBtn_CT = ft.QPushButton('<')
    self.redMinLeftBtn_CT.clicked.connect(self.redMinLeftBtn_CT_clicked)
    self.redMinRightBtn_CT = ft.QPushButton('>')
    ...
    self.redMaxLeftBtn_CT = ft.QPushButton('<')
    self.redMaxLeftBtn_CT.clicked.connect(self.redMaxLeftBtn_CT_clicked)
    self.redMaxRightBtn_CT = ft.QPushButton('>')
    ...
    self.greenMinLeftBtn_CT = ft.QPushButton('<')
    self.greenMinLeftBtn_CT.clicked.connect(self.greenMinLeftBtn_CT_clicked)
    self.greenMinRightBtn_CT = ft.QPushButton('>')
    ...
    self.greenMaxLeftBtn_CT = ft.QPushButton('<')
    self.greenMaxLeftBtn_CT.clicked.connect(self.greenMaxLeftBtn_CT_clicked)
    self.greenMaxRightBtn_CT = ft.QPushButton('>')
    ...
    self.blueMinLeftBtn_CT = ft.QPushButton('<')
    self.blueMinLeftBtn_CT.clicked.connect(self.blueMinLeftBtn_CT_clicked)
    self.blueMinRightBtn_CT = ft.QPushButton('>')
    ...
    self.blueMaxLeftBtn_CT = ft.QPushButton('<')
    self.blueMaxLeftBtn_CT.clicked.connect(self.blueMaxLeftBtn_CT_clicked)
    self.blueMaxRightBtn_CT = ft.QPushButton('>')
    ...
    self.filterParticleSldr_CT = ft.QSlider(ft.Qt.Orientation.Horizontal)
    ...
    self.box_layout.addWidget(self.redMinLeftBtn_CT, 2, 1, 1, 1)
    self.box_layout.addWidget(self.redMinRightBtn_CT, 2, 4, 1, 1)
    self.box_layout.addWidget(self.redMinSlider, 2, 2, 1, 2)
    self.box_layout.addWidget(redMaxTxt, 3, 0, 1, 1)
    self.box_layout.addWidget(self.redMaxLeftBtn_CT, 3, 1, 1, 1)
    self.box_layout.addWidget(self.redMaxRightBtn_CT, 3, 4, 1, 1)
    ...
    self.box_layout.addWidget(self.greenMinLeftBtn_CT, 5, 1, 1, 1)
    self.box_layout.addWidget(self.greenMinRightBtn_CT, 5, 4, 1, 1)
    self.box_layout.addWidget(self.greenMinSlider, 5, 2, 1, 2)
    self.box_layout.addWidget(greenMaxTxt, 6, 0, 1, 1)
    self.box_layout.addWidget(self.greenMaxLeftBtn_CT, 6, 1, 1, 1)
    self.box_layout.addWidget(self.greenMaxRightBtn_CT, 6, 4, 1, 1)
    ...
    self.box_layout.addWidget(self.blueMinLeftBtn_CT, 8, 1, 1, 1)
    self.box_layout.addWidget(self.blueMinRightBtn_CT, 8, 4, 1, 1)
    self.box_layout.addWidget(self.blueMinSlider, 8, 2, 1, 2)
    self.box_layout.addWidget(blueMaxTxt, 9, 0, 1, 1)
    self.box_layout.addWidget(self.blueMaxLeftBtn_CT, 9, 1, 1, 1)
    self.box_layout.addWidget(self.blueMaxRightBtn_CT, 9, 4, 1, 1)
    ...
    self.box_layout.addWidget(self.filterParticleSldr_CT, 11, 2, 1, 2)
    ...
    self.box_layout.addWidget(self.avgLEIn_CT, 1, 6, 1, 1)
    self.box_layout.addWidget(movAvgTxt, 2, 5, 1, 2)
    self.box_layout.addWidget(self.movAvgIn_CT, 2, 6, 1, 1)
    self.box_layout.addWidget(self.colorTrackingBtn, 3, 5, 1, 2)
    self.box_layout.addWidget(self.saveBtn_CT, 4, 5, 1, 2)
    self.box_layout.addWidget(self.saveChannelsBtn_CT, 5, 5, 1, 2)
    self.box_layout.addWidget(self.loadChannelsBtn_CT, 6, 5, 1, 2)
    self.box_layout.addWidget(self.updateGraphsBtn_CT, 7, 5, 1, 2)

    # first label
    self.lbl1_CT = ft.QLabel()
    self.lbl1_CT.setStyleSheet('background-color: white')

    # second label
    self.lbl2_CT = ft.QLabel()
    ...
    self.box_layout.addWidget(self.lbl1_CT, 0, 9, 8, 3)
    self.box_layout.addWidget(self.lbl2_CT, 0, 12, 8, 3)
    ...
    showFrameLargeBtn_CT = ft.QAction('Show filtered frame', self)
    showFrameLargeBtn_CT.triggered.connect(self.showFrameLargeBtn_CT_clicked)
    self.filterLight_CT = ft.QAction('Ignore flashing light', self)
    self.filterLight_CT.setCheckable(True)
    self.lightROIBtn_CT = ft.QAction('Pick bright region', self)
    self.lightROIBtn_CT.triggered.connect(self.lightROIBtn_CT_clicked)
    self.absValBtn_CT = ft.QAction('Absolute values', self)
    self.absValBtn_CT.triggered.connect(self.absValBtn_CT_clicked)
    self.showEdges_CT = ft.QAction('Show edge lines', self)
    self.showEdges_CT.setCheckable(True)
    self.showEdges_CT.setChecked(True)
    self.exportEdges_CT = ft.QAction('Output video analysis', self)
    self.exportEdges_CT.setCheckable(True)

    self.CTmenu = self.menu.addMenu('&RGB Tracking')

    connectivitySub = self.CTmenu.addMenu('Connectivity (px)')
    ...
    self.CTmenu.addAction(showFrameLargeBtn_CT)
    self.CTmenu.addAction(self.filterLight_CT)
    self.CTmenu.addAction(self.lightROIBtn_CT)
    self.CTmenu.addAction(self.absValBtn_CT)
    self.CTmenu.addAction(self.showEdges_CT)
    self.CTmenu.addAction(self.exportEdges_CT)
