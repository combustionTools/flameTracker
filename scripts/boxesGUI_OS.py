...
def manualTrackingBox(self):
    if ft.sys.platform == 'darwin':
        ...
        if self.pyqtVer == '5':
            ...
            # first column
            x1 = [ 10,   5,  10,  10,   5,  10, 120,  10,  10,  10,  10,  10]
            y1 = [ 20,  45,  70,  95, 125, 150, 154, 180, 210, 240, 270, 300]
            w1 = [100, 150, 150, 140, 150, 100,  30, 140, 140, 140, 140, 140]
    ...
    # #first column
    directionBoxTxt = ft.QLabel('Flame direction:', self.manualTrackingBox)
...
def lumaTrackingBox(self):
    ...
    #first column
    directionBoxTxt = ft.QLabel('Flame direction:', self.lumaTrackingBox)
    directionBoxTxt.setGeometry(x1[0], y1[0], w1[0], h_txt)
...
def colorTrackingBox(self):
    ...
    # #first column
    directionBoxTxt = ft.QLabel('Flame direction:', self.colorTrackingBox)
    directionBoxTxt.setGeometry(x1[0], y1[0], w1[0], h_txt)
...
def HSVTrackingBox(self):
    ...
    # first column
    directionBoxTxt = ft.QLabel('Flame direction:', self.HSVTrackingBox)
    directionBoxTxt.setGeometry(x1[0], y1[0], w1[0], h_txt)
