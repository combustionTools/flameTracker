...
def createManualTrackingBox(self):
    manualTrackingBox = QGroupBox('Analysis box', self.analysisGroupBox)
    manualTrackingBox.setGeometry(0, 0, 1050, 370)
    ...
    self.filterLight.setGeometry(x_cln1, 95, 140, h_btn)
...
def manualTracking(self):
    ...
    while (currentFrame < lastFrame):
        ...
        # this condition skips frames if more than half area is illuminated by the lamp
    ...
    if scale:
        ...
        self.label1.clear()
        self.label2.clear()
        self.label1.addLegend(offset = [1, 0.1]) # background color modified in line 122 and 123 of Versions/3.7/lib/python3.7/site-packages/pyqtgraph/graphicsItems
