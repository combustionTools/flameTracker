...
class LegendItem(GraphicsWidget, GraphicsWidgetAnchor):
    ...
    def addItem(self, item, name):
        ...
        **Arguments:**
        ...
        ==============  ========================================================
        """
        label = LabelItem(name, color = 'k', size = '10pt')
    ...
    def paint(self, p, *args):
        p.setPen(fn.mkPen(255,255,255,100)) # 0,0,0,100 originally = (255,255,255,100)
        p.setBrush(fn.mkBrush(255,255,255,50)) # originally = (100,100,100,50))
